...
def movie():
    ...
    return render_template("movie/movie.html", movies=movies, genres=genres, curuser=curuser)
...
def find_by_name():
    ...
    curuser = current_user
    return render_template("movie/movieList.html", movies=rows.all(), genres=genres, curuser=curuser)
...
def find_by_genre():
    ...
    curuser = current_user
    return render_template("movie/movieList.html", movies=moviesList, genres=gens, curuser=curuser)
...
def sort_by_general_rating():
    ...
    gens = Genre.query.all()
    curuser = current_user
    return render_template("movie/movieList.html", movies=mov, genres=gens, curuser=curuser)
...
def find_by_genre_in_library():
    ...
    for element in user.movies:
        if all(elem in element.genres for elem in genresToFind):
            ...
            print('')
    curuser = current_user
    return render_template("user/movieSortsResult.html", movies=moviesList, genres=gens, curuser=curuser)
...
def find_by_criteria_in_library():
    ...
    curuser = current_user
    return render_template("user/movieSortsResult.html", movies=selected_movies, genres=genres, curuser=curuser)
